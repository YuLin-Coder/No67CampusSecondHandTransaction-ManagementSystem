...
<body style="padding:10px">
	...
	<div class="wrap round-block">
		<div class="line-title">
			当前位置：<a href="${pageContext.request.contextPath }/e/index.jsp">首页</a> &gt;&gt; 取消订单
		</div>
					...
					<tr>
						<td colspan="4">
						 ...
						 <form name="payform" method="post" action="${pageContext.request.contextPath}/admin/dingdanmanager.do">
						      ...
						      <input type="hidden" name="errorurl" value="/e/huiyuan/cancelorder.jsp"/>
						      <input type="hidden" name="forwardurl" value="/e/huiyuan/cancelresult.jsp"/>
						      <input type="hidden" name="ddid" value="<%=id%>"/>
						      
						      <input type="submit" class="dw-btn" value="取消订单"/>
