							...
							<tbody>
								<tr>
									<td>订单号 <input name="ddno" value="${ddno}"
										...
										<input type="hidden" name="shaccount" value="${huiyuan.accountname}" />
				    ...
				    <%} %>
								...
								<td>
								  ...
								  %>
								   ...
								   <a class="orange-href"  href="${pageContext.request.contextPath}/e/huiyuan/fahuo.jsp?id=<%=temdingdan.getId()%>">发货</a>
								  <%} %>
