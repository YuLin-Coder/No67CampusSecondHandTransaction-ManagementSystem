							...
							<tbody>
								<tr>
									<td>标题 <input name="title" value="${title}"
										...
										type="hidden" name="lyren" value="${huiyuan.accountname}" />
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<%
							 %> <a class="orange-href"
								href="${pageContext.request.contextPath}/e/huiyuan/leaveworddetails.jsp?id=<%=temleaveword.getId()%>&seedid=106">查看</a>
