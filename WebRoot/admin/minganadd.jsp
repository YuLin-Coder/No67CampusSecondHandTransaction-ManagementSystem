...
<h2>
				    ...
				    <form name="minganform"  method="post" action="${pageContext.request.contextPath}/admin/minganmanager.do"  id="minganForm">
						        ...
						        <tr>
								  <td colspan="4">
								      ${errormsg}
											   ...
											   <td>
												   <input name="name" placeholder="名称" validate="{required:true,messages:{required:'请输入名称'}}" value="${requestScope.mingan.name}" class="input-txt" type="text" id="txtName"  />
												</td>
											   </tr>
						   <tr>
						       <td colspan="4">
