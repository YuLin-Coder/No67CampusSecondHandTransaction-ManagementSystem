...
<body>
	<div class="search-title">
		...
		<div class="description">
			<a
				href="${pageContext.request.contextPath}/admin/spcategorymanager.do?actiontype=get&forwardurl=/admin/columnguide.jsp">新建首页栏目</a>
	...
	<table id="indexcolumns" width="100%" border="0" cellspacing="0"
		...
		<tbody>
			...
			<tr>
				...
				<td><%if(temindexcolumns.getLayout()!=null&&temindexcolumns.getLayout().equals("1")){%>
				        独立行显示
				    <%} %>
				    <%if(temindexcolumns.getLayout()!=null&&temindexcolumns.getLayout().equals("2")){%>
				       行内显示
				    <%} %>
				</td>
